...
export const StackNavigation: FC = function () {
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        ...
        header({ navigation, options, route }) {
          const headerOptions =
            ROUTE_HEADER_OPTIONS[
              route.name as keyof typeof ROUTE_HEADER_OPTIONS
            ];
          return (
            <View
              style={{
    ...
    >
      ...
      <Stack.Screen
        name="verify-otp"
        options={{ title: "OTP Verification", animation: "slide_from_right" }}
        component={OtpVerification}
      />
      <Stack.Screen
        name="create-password"
        options={{ title: "Create password", animation: "slide_from_right" }}
        component={CreatePassword}
      />
      <Stack.Screen
        name="forgot-password"
        options={{ title: "Forget Password", animation: "slide_from_right" }}
        component={ForgotPassword}
      />
      <Stack.Screen
        name="select-location"
        options={{ title: "Select Location", animation: "slide_from_right" }}
