        ...
        <View style={[$.screen, { paddingHorizontal: 18 }]}>
          ...
          <View style={$.col}>
            ...
            <View
              style={[
                $.row,
                { justifyContent: "space-around", marginVertical: 15 },
              ]}
            >
              <IconButton
...
const IconButton: FC<IconButtonProps> = function ({ icon, title }) {
  return (
